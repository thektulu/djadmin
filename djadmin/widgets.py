...
class AdminSplitDateTime(forms.SplitDateTimeWidget):
    ...
    """
    template_name = 'djadmin/widgets/split_datetime.html'
...
class AdminRadioSelect(forms.RadioSelect):
    template_name = 'djadmin/widgets/radio.html'


class AdminFileWidget(forms.ClearableFileInput):
    template_name = 'djadmin/widgets/clearable_file_input.html'
...
class ForeignKeyRawIdWidget(forms.TextInput):
    ...
    in a <select> box.
    """
    template_name = 'djadmin/widgets/foreign_key_raw_id.html'
...
class ManyToManyRawIdWidget(ForeignKeyRawIdWidget):
    ...
    """
    template_name = 'djadmin/widgets/many_to_many_raw_id.html'
...
class RelatedFieldWidgetWrapper(forms.Widget):
    ...
    admin interface.
    """
    template_name = 'djadmin/widgets/related_widget_wrapper.html'
...
class AdminURLFieldWidget(forms.URLInput):
    template_name = 'djadmin/widgets/url.html'
